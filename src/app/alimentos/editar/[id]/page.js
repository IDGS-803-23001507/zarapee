...
export default function EditarAlimentoPage() {
  ...
  if (loading) return <div className="p-8 text-black">Cargando datos...</div>;

  return (
    <div className="p-8 bg-[#FAF4ED] min-h-screen text-[#3B2523] font-sans">
      <div className="max-w-xl mx-auto">
        <h1 className="text-4xl font-serif font-bold text-[#2D1A1A] mb-8 text-center">Edición de Alimento</h1>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-[#F0E6D8]">
          <div className="flex justify-between items-center mb-8 border-b border-[#F0E6D8] pb-4">
            <h2 className="text-sm font-bold text-[#3B2523] tracking-[0.15em] uppercase">Edición</h2>
